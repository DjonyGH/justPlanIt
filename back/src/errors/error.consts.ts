// USERS
export const ERROR_OF_USER_CREATE = 'Error of user create';
...
export const ERROR_OF_LOGIN_ALREADY_EXIST =
  'Пользователь с таким логином уже существует';
export const ERROR_OF_EMAIL_ALREADY_EXIST =
  'Пользователь с таким email уже существует';
export const ERROR_OF_VERIFY_CODE = 'Неверный проверочный код';
